<?php
/**
 * ThemesGenerator: Color Patterns
 */

/**
 * Generate the CSS for the current custom color scheme.
 */
function themesgenerator_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter ThemesGenerator default saturation level.
	 *
	 * @since ThemesGenerator 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'themesgenerator_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.themesgenerator-front-page) .entry-title,
...
.colors-custom .themesgenerator-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.themesgenerator-front-page .panel-content .recent-posts article,
...
.colors-custom.themesgenerator-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters ThemesGenerator custom colors CSS.
	 *
	 * @since ThemesGenerator 1.0
	 *
	 ...
	 */
	return apply_filters( 'themesgenerator_custom_colors_css', $css, $hue, $saturation );
}
